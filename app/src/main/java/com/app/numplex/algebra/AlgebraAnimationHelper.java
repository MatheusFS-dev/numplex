...
public class AlgebraAnimationHelper {

    BaseAdapter adapter;
    ListView listView;
    ArrayList<Elements> dataSource;
...
// ================================================================================
    ...
    public AlgebraAnimationHelper(BaseAdapter adapter, ListView listView, ArrayList<Elements>dataSource) {
