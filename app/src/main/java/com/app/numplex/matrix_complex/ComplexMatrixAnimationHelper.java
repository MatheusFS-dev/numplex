...
public class ComplexMatrixAnimationHelper {

    BaseAdapter adapter;
    ListView listView;
    ArrayList<ComplexMatrix> dataSource;
...
// ================================================================================
    ...
    public ComplexMatrixAnimationHelper(BaseAdapter adapter, ListView listView, ArrayList<ComplexMatrix>dataSource) {
