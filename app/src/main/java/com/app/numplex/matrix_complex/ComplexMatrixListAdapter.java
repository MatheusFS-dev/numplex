...
public class ComplexMatrixListAdapter extends ArrayAdapter<ComplexMatrix> {
    private final ArrayList<ComplexMatrix> data;
    private final Context context;

    public ComplexMatrixListAdapter(Context context, ArrayList<ComplexMatrix> dataList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ComplexMatrix matrix = getItem(position);
        ...
        if(matrix.isChecked()) {
            if(!MatrixComplexActivity.onlyOne) {
        ...
        Drawable drawable = ContextCompat.getDrawable(context, R.drawable.ic_complex_matrix);
