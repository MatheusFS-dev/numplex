...
public class MatrixAnimationHelper {

    BaseAdapter adapter;
    ListView listView;
    ArrayList<Matrix> dataSource;
...
// ================================================================================
    ...
    public MatrixAnimationHelper(BaseAdapter adapter, ListView listView, ArrayList<Matrix>dataSource) {
